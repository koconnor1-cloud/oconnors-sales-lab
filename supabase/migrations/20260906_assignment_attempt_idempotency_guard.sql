-- September 6, 2026 reliability fix.
-- A repeated save of the same formal submission should not consume another
-- assignment attempt. client_submission_id is generated once per student
-- performance and is protected by sessions_formal_submission_idempotency_idx.
...
begin
  ...
  where s.student_id=new.student_id
    ...
    and (
      new.client_submission_id is null
      or s.client_submission_id is distinct from new.client_submission_id
    );
