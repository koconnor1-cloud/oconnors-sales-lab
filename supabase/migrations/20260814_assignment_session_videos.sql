-- Fall 2026 launch readiness: assignment-only video recording.
-- Free practice remains unrecorded. This schema stores only explicitly consented
-- videos linked to an instructor-assigned Sales Lab attempt.
...
drop policy if exists "Students insert own assignment videos" on public.session_videos;
